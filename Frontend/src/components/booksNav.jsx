...
function BooksNav() {
  ...
  return (
    <>
<div className={` max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-500 dark:text-white fixed top-[14%] left-0 right-0 z-50 rounded-md hidden md:block ${
          sticky
